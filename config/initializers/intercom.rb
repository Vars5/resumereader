IntercomRails.config do |config|
  # == Intercom app_id
  # 
  config.app_id = ENV["INTERCOM_APP_ID"] || "qo4fbgih"

  # == Intercom secret key 
  # This is required to enable secure mode, you can find it on your Intercom 
  # "security" configuration page.
  # 
  config.api_secret = "jAM57tht9vWLWBqkPm_bnARWJob62nS5eq6V_yh7"
  ...
  #
  config.api_key = "5f22555c7b33a96ec6f4ebf14db797fd244835bc"
